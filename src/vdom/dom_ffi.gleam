...
pub fn browser_init_loop(init_model: state, update: func_1, view: func_2, root: DomElement ,events: List(String), diff_one: func_3, apply_dom: func_4) -> Nil
...
pub fn set_attribute_type(ele: DomElement, props: List(v_dom.Atrribute(msg))) -> List(String){
    case props{
        [] -> []
        [first] -> {
            case first {
...
pub fn remove_attribute_type(ele: DomElement, props: List(v_dom.Atrribute(msg)))-> Nil{
    case props{
        [] -> Nil 
        [first] -> {
            case first {
